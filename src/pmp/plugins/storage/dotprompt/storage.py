...
from pmp.backends.storage.base import PromptStorageBackendPlugin, hookimpl
...
from pmp.plugins.storage.dotprompt.versioning import DotpromptVersion

class DotPromptBackendStoragePlugin(PromptStorageBackendPlugin):
